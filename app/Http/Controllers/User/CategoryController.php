...
class CategoryController extends Controller
{
    ...
    public function update(Request $request, Category $category)
    {
        ...
        return redirect()->route('category.index')->with('success','Updated Created');
    }
    ...
    public function trashedCategory(){
         return view('backpanel.categories.trash')->with('categories',Category::onlyTrashed()->get());
    }

    public function restoreCategory($id)
    {
        Category::withTrashed()->where('id' ,$id)->restore();
        return redirect()->route('category.index')->with('success','Category Restored ');
    }

    public function permaDelCategory($id)
    {
